...
import AppBlueContainer from "./components/AppBlueContainer.vue";
import AppMenuContainer from "./components/AppMenuContainer.vue";
...
<template>
  <AppHeader />
  <main>
    <AppCardContainer :comics="comics" />
    <AppBlueContainer />
    <AppMenuContainer />
  </main>
  <footer>
